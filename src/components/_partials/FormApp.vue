  ...
  <div class="my-10">
    ...
    >
      ...
      <div class="mb-4">
        <label
          for="name"
          class="block text-light-text dark:text-dark-text text-sm font-bold mb-2"
          >Nome</label
        >
        <input
          type="text"
          ...
          class="placeholder:text-dark-text w-full bg-light-primary dark:bg-dark-primary border p-2 rounded-md"
        />
        <p v-if="!validateName" class="text-dark-red text-sm mt-1">
      ...
      <div class="mb-4">
        ...
        <input
          ...
          class="placeholder:text-dark-text w-full bg-light-primary dark:bg-dark-primary border p-2 rounded-md"
        />
        <p v-if="!validateEmail" class="text-dark-red text-sm mt-1">
      ...
      <div class="mb-6">
        ...
        <textarea
          ...
          class="placeholder:text-dark-text w-full bg-light-primary dark:bg-dark-primary border p-2 rounded-md"
        ></textarea>
        <p v-if="!validateMessage" class="text-dark-red text-sm mt-1">
